...
Refinery::Resources.configure do |config|
  ...
  # config.dragonfly_secret = "c0c7918d4c4cee14b4eda6a72619d6bfe4dcd3d3813bf97e"
  # config.dragonfly_url_format = "/system/resources/:job/:basename.:ext"
  # config.dragonfly_url_host = ""
  # config.datastore_root_path = "/Volumes/WalterSr/Users/kaitlynhova/Refinery-discovery/refinery-discovery/public/system/refinery/resources"
